...
# map_eqtl_GPU_Ctrl_trans_all.sh - Map all trans Ctrl eQTLs
...
#$ -j y
#$ -o map_eqtl_GPU_Ctrl_trans_all.out
...
mkdir -p ./Ctrl_trans_eqtl_result_all
python3 -m tensorqtl Dmel_Ctrl_final_eqtl Ctrl_phenos_trans_eQTL_mapping.bed Ctrl --mode trans --output_text --pval_threshold 1 --seed 4 -o ./Ctrl_trans_eqtl_result_all
