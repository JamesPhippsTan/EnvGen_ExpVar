...
for (sample_size in downsample_sizes){
  for (seed in downsampling_seeds){
    ...
    # Well was not modelled as there is too few samples per well at low sample sizes
...
save.image(file='DE_DV_Downsampled_Series_50100.RData')
